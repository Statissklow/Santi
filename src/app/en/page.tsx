        ...
        <div className="font-[family-name:var(--font-roboto)]">
                ...
                <div className="flex items-center p-8 lg:p-12 order-2 lg:order-1 lg:col-span-4 bg-[#1c1d26] relative z-20">
                    <div className="w-full mr-auto text-left pl-4 lg:pl-0 lg:ml-0 xl:ml-0">
                        <FadeIn direction="right">
                            <h2 className="text-4xl font-bold text-white mb-6">About Santino</h2>
                            <p className="text-white/70 mb-4 leading-relaxed text-lg">
                                Santino Scavelli is one of the most exciting newcomers in the world music scene.
                                With his unique style and skill, he has already received several prestigious awards.
                            </p>
                            <p className="text-white/70 mb-8 leading-relaxed text-lg">
                                As Musical Director at the National Theatre Mannheim and through his collaboration
                                with international artists, he has gained widespread recognition.
                            </p>
                            <Link href="/en/about" className="inline-block border border-[#e44c65] text-[#e44c65] px-8 py-3 rounded hover:bg-[#e44c65] hover:text-white transition-all shadow-[0_0_15px_rgba(228,76,101,0.1)] hover:shadow-[0_0_25px_rgba(228,76,101,0.4)]">
                                Learn more
                            </Link>
                        </FadeIn>
                    </div>
                ...
                <div className="flex items-center p-8 lg:p-12 order-2 lg:col-span-4 bg-[#1e1f29] relative z-20">
                    <div className="w-full ml-auto text-left pr-4 lg:pr-0 lg:mr-0 xl:mr-0">
                        <FadeIn direction="left">
                            ...
                            <p className="text-white/70 mb-8 leading-relaxed text-lg">
                                The highlight: His self-built hybrid &quot;Split-Set&quot;, perfect for organic-electronic beats.
                                Get the fat sound for your production!
                            </p>
                            <Link href="/en/recording" className="inline-block border border-[#e44c65] text-[#e44c65] px-8 py-3 rounded hover:bg-[#e44c65] hover:text-white transition-all shadow-[0_0_15px_rgba(228,76,101,0.1)] hover:shadow-[0_0_25px_rgba(228,76,101,0.4)]">
                                Visit Studio
                            </Link>
                        </FadeIn>
                    </div>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-12 min-h-[60vh] bg-[#1c1d26] overflow-hidden">
                ...
                <div className="flex items-center p-8 lg:p-12 order-2 lg:order-1 lg:col-span-4 bg-[#1c1d26] relative z-20">
                    <div className="w-full mr-auto text-left pl-4 lg:pl-0 lg:ml-0 xl:ml-0">
                        <FadeIn direction="right">
                            <h2 className="text-4xl font-bold text-white mb-6">Lessons</h2>
                            <p className="text-white/70 mb-4 leading-relaxed text-lg font-medium text-white/90">
                                Unleash your rhythmic potential!
                            </p>
                            <p className="text-white/70 mb-4 leading-relaxed text-lg">
                                Whether you are a complete beginner or an advanced pro – with me, it&apos;s not just about technique,
                                but about <strong>expression, groove, and passion</strong>.
                            </p>
                            <p className="text-white/70 mb-8 leading-relaxed text-lg">
                                Experience modern drum lessons that really take you further.
                                Individual coaching, practical concepts, and the direct way to your own sound.
                            </p>
                            <Link href="/en/lessons" className="inline-block border border-[#e44c65] text-[#e44c65] px-8 py-3 rounded hover:bg-[#e44c65] hover:text-white transition-all shadow-[0_0_15px_rgba(228,76,101,0.1)] hover:shadow-[0_0_25px_rgba(228,76,101,0.4)]">
                                Get started now
                            </Link>
                        </FadeIn>
                    </div>
            ...
            <section className="py-20 bg-[#e44c65] text-center px-6 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    <FadeIn direction="up">
                        <h2 className="text-4xl font-bold text-white mb-4 drop-shadow-md">Subscribe to Newsletter</h2>
                        ...
                        <div className="border-t border-white/30 pt-10 mt-8">
                            <p className="text-white/80 mb-8 font-bold tracking-widest uppercase text-sm">Follow me on Social Media</p>
