            ...
            <main className="max-w-7xl mx-auto space-y-16">
                ...
                <section className="text-center space-y-6 pt-8">
                    ...
                    <p className="text-xl sm:text-2xl text-white/60 max-w-3xl mx-auto">
                        High-End Drums & Percussion Recording from Rama Studio Mannheim.
                    </p>
                </section>
                ...
                <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start bg-white/5 p-8 sm:p-12 rounded-3xl border border-white/5 backdrop-blur-sm">
                    <div className="lg:col-span-7 space-y-6 text-lg text-white/80 leading-relaxed">
                        <h2 className="text-3xl font-bold text-white mb-4">Professional Rhythm Recordings</h2>
                        <p>
                            Santino Scavelli is a sought-after studio musician. In his studio, he records for renowned artists (Anika Nilles, Viktor) – whether percussion, drums, or both.
                        </p>
                        <p>
                            Through collaboration with experienced percussionists and drummers, we offer tailored solutions for your musical projects.
                            Thanks to our exclusive cooperation with <strong>Rama Studio</strong>, you get high-quality recordings in a professional setting.
                        </p>
                        <p>
                            Particularly in demand is his self-built hybrid set, which he calls <strong className="text-[#e44c65]">&quot;Split-Set&quot;</strong>. This is excellently suited for organic-electronic beats as well as for folkloric music.
                        </p>
                    </div>

                    <div className="lg:col-span-5 flex flex-col gap-6">
                        <div className="bg-[#1c1d26] p-8 rounded-2xl border border-[#e44c65]/30 shadow-[0_0_30px_rgba(228,76,101,0.15)]">
                            <h4 className="text-[#e44c65] font-bold text-2xl mb-4">Book Recording</h4>
                            <p className="text-white/70 mb-6">
                                Whether a simple shaker loop, complex percussion arrangements, or a full drum recording. We find the perfect sound for your track.
                            </p>
